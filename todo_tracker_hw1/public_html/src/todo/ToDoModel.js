...
export default class ToDoModel {
    ...
    /*
     * Moves the current list to top of left side-bar
     */
    promoteCurrentList() {
        let indexOfList = -1;
        for (let i = 0; (i < this.toDoLists.length) && (indexOfList < 0); i++) {
        ...
        this.highlightCurrentList();
    }

     /*
     * highlights current list
     */
    highlightCurrentList() {
        ...
        let list = document.getElementById(`todo-list-${this.currentList.id}`);
